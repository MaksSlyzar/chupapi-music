...
var Profile = /** @class */ (function (_super) {
    ...
    function Profile(user, channel, history, index, message) {
    ...
    Profile.prototype.embedMessage = function () {
        return new discord_js_1.EmbedBuilder()
            .setTitle("Profile <📙>")
            .setDescription("Level ".concat(1))
            // .setAuthor({ name: `${this.user.username}#${this.user.discriminator}`})
            .setColor("#2F3136");
    };
    Profile.prototype.generateMessage = function () {
    ...
    Profile.prototype.regenerateMessage = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Profile.prototype.setupCollector = function () {
        var _this = this;
