...
var Quests = /** @class */ (function (_super) {
    __extends(Quests, _super);
    function Quests(user, channel, history, index, message) {
    ...
    Quests.prototype.embedMessage = function (id) {
        if (id == 0) {
        ...
        return new discord_js_1.EmbedBuilder()
            .setTitle("Quests <".concat(id, ">"))
            .setDescription("1. None;\n                                                 2. None;")
            // .setAuthor({ name: `${this.user.username}#${this.user.discriminator}`})
            .setColor("#2F3136");
    };
    Quests.prototype.generateMessage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var playerData, playerId, embed, emojies;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, UserSchema_1.default.findOne({ 'userId': this.user.id })];
                    case 1:
                        playerData = _a.sent();
                        if (playerData == null)
                            playerId = 0;
                        ...
                        embed = this.embedMessage(playerId);
    ...
    Quests.prototype.setupCollector = function () {
        var _this = this;
        var filter = function (reaction, user) {
            return ["⬅️", "🏹"].includes(reaction.emoji.name) && user.id === _this.user.id;
        };
        ...
        collector.on("end", function (reason) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.removeMessage();
