...
var TurnButton = /** @class */ (function (_super) {
    __extends(TurnButton, _super);
    function TurnButton(voiceManager) {
        var _this = _super.call(this, voiceManager) || this;
        _this.customId = "id-turn";
        return _this;
    }
    TurnButton.prototype.buildButton = function () {
        return new discord_js_1.ButtonBuilder()
            .setCustomId(this.customId)
            .setLabel('Turn')
            .setStyle(discord_js_1.ButtonStyle.Secondary)
            .setEmoji(emojies_music_json_1.playlistEmoji);
    };
    TurnButton.prototype.pressed = function (i, collector) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        console.log("ERROR");
                        return [3 /*break*/, 4];
                    case 4: return [4 /*yield*/, this.voiceManager.chooseWindow("playlist")];
                    case 5:
                        _a.sent();
