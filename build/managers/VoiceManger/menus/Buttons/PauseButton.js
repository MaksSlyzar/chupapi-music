...
var PauseButton = /** @class */ (function (_super) {
    ...
    function PauseButton(voiceManager) {
        var _this = _super.call(this, voiceManager) || this;
        _this.customId = "id-pause";
        _this.pause = false;
        return _this;
    }
    PauseButton.prototype.buildButton = function () {
        // this.button = new ButtonBuilder()
        // .setCustomId(this.customId)
        // .setEmoji(checkerEmoji)
        // .setStyle(ButtonStyle.Secondary)
        // return this.button
        return this.voiceManager.paused == true ? new discord_js_1.ButtonBuilder()
            .setCustomId(this.customId)
            .setEmoji(emojies_music_json_1.checkerEmoji)
            .setStyle(discord_js_1.ButtonStyle.Secondary)
            : new discord_js_1.ButtonBuilder()
                .setCustomId(this.customId)
                .setEmoji(emojies_music_json_1.pauseEmoji)
                .setStyle(discord_js_1.ButtonStyle.Secondary);
    };
    PauseButton.prototype.pressed = function (i, collector) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, i.update({ content: "---" })];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.voiceManager.chooseWindow(this.voiceManager.nowWindow)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
