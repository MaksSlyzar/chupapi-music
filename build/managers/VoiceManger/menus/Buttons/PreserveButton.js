...
var PreserveButton = /** @class */ (function (_super) {
    __extends(PreserveButton, _super);
    function PreserveButton(voiceManager) {
        var _this = _super.call(this, voiceManager) || this;
        _this.customId = "id-preserve";
        return _this;
    }
    PreserveButton.prototype.buildButton = function () {
        return new discord_js_1.ButtonBuilder()
            .setCustomId(this.customId)
            .setEmoji(emojies_music_json_1.preserveEmoji)
            .setStyle(discord_js_1.ButtonStyle.Secondary);
    };
    PreserveButton.prototype.pressed = function (i, collector) {
...
exports.default = PreserveButton;
