...
var MusicDatas = /** @class */ (function () {
    ...
    MusicDatas.prototype.addTrack = function (input, user) {
        return __awaiter(this, void 0, void 0, function () {
            var validate, track, music, playlist_1, allTracks, error_1, track, music, playlist, minAllVideos, i, videoMin, track, music, search, track, music, e_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 25, , 26]);
                        return [4 /*yield*/, play_dl_1.default.validate(input)];
                    case 1:
                        validate = _a.sent();
                    ...
                    case 11:
                        ...
                        return [3 /*break*/, 24];
                    case 12:
                        if (!(validate == "yt_playlist")) return [3 /*break*/, 20];
                    ...
                    case 20:
                        if (!(validate == "search")) return [3 /*break*/, 24];
