...
exports.client.on("messageCreate", function (message) { return __awaiter(void 0, void 0, void 0, function () {
    var commandName, guildId, guildManager, _i, guildManagers_1, value, channel, _user, sounds;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (commandName == "gitler") {
                    channel.send({ embeds: [new discord_js_1.EmbedBuilder().setImage("https://www.history.com/.image/ar_16:9%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cg_faces:center%2Cq_auto:good%2Cw_768/MTk1MTQzMjg1OTYwODc3MjU1/adolf-hitler-gettyimages-119505258.jpg")] });
                }
